<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProspectusGeneralRaceCardCondition.aspx.cs" Inherits="VKATalk.PopUps.ProspectusGeneralRaceCardCondition" %>
    ...
    <script type="text/javascript">
        ...
        function ShowPopup(message) {
            $(function () {
                $("#dialog").html(message);
                $("#dialog").dialog({
                    title: "General Race Card Condition",
                    buttons: {
                        Close: function () {
                            $(this).dialog('close');
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ToolkitScriptManager2" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">General Race Card Condition</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="PGRaceCardCondition" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                ...
                <tr>
                    <td>Race Card Condition(*):

                    </td>
                    <td>
                        <asp:DropDownList ID="drpdwnRaceCard" runat="server"></asp:DropDownList>
                          <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic" 
                            ValidationGroup="PGRaceCardCondition" runat="server" ControlToValidate="drpdwnRaceCard"
                            Text="*" ErrorMessage="Please select race card condition"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                <td>From Date:(*)
                ...
                <td>
                    ...
                    <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                        ...
                        ValidationGroup="PGRaceCardCondition" />
            ...
            <tr>
                ...
                <tr>
                    <td colspan="1"></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="PGRaceCardCondition" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="PGRaceCardCondition"/>    
            ...
            <table>
             ...
             <div id="dvProspectus" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvProspectus" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="PGRaceCardConditionID" OnSelectedIndexChanged="GvProspectus_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Race Card Condition" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldtypeofdate" Value='<%# Bind("RaceCardCondition") %>'/>
                                <asp:LinkButton Text='<%# Bind("RaceCardCondition") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
