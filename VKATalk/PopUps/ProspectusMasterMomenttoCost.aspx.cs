...
namespace VKATalk.PopUps
{
    ...
    public partial class ProspectusMasterMomenttoCost : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ds = new ProspectusBL().GetProspectusTillDateValidation(_masterraceId, "MomenttoCost", drpdwnFromYear.SelectedItem.Text, btnSave.Text);
                }
                else
                {
                    ds = new ProspectusBL().GetProspectusTillDateValidation((int)ViewState["MasterRaceID"], "MomenttoCost", drpdwnFromYear.SelectedItem.Text, btnSave.Text);
                }
                ...
                else
                {
                    if (btnSave.Text.Equals("Add"))
                    {
                        status = new ProspectusBL().MomenttoCost(
                            _masterraceId,
                            txtbxMemoirType.Text,
        ...
        public static List<string> AddCommentsList(string prefixText, int count)
        {
            ...
            DataTable dt = new ProspectusBL().GetprospectusAutoFiller("ProspectusMasterMomenttoCostCommentList", prefixText);
        ...
        {
            DataTable dt = new ProspectusBL().GetprospectusAutoFiller("ProspectusMasterMomenttoCost", prefixText);
            List<string> commentList = new List<string>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                commentList.Add(dt.Rows[i][0].ToString());
        ...
        private void BindData()
        {
            try
            {
                ...
                DataSet ds = new ProspectusBL().GetProspectusNameWithCombination(_masterraceId, "ProspectusMasterMomenttoCost");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (!ViewState["MasterRaceID"].Equals(""))
                {
                    ...
                    var status = new ProspectusBL().MomenttoCost((int)ViewState["MasterRaceID"],"", 0,0,txtbxComment.Text, 1, "Delete");
        ...
        protected void btnFileUpload_Click(object sender, EventArgs e)
        {
            try
            {
                if (flupload.HasFile)
                {
                    ...
                    if (Path.GetFileNameWithoutExtension(flupload.PostedFile.FileName).Equals("Prospectus_Master_MomenttoCost"))
                    {
        ...
        private void Import_To_Grid(string FilePath, string Extension)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    var dtErrorResult = new ProspectusBL().Import30(dt, "MomenttoCost", _masterraceId);
                    if (dtErrorResult.Rows.Count > 0)
                    {
                        ...
                        using (ExcelPackage xp = new ExcelPackage())
                        {
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=Prospectus_Master_MomenttoCost.xlsx");
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (DataSet ds = new ProspectusBL().GetExport(_masterraceId, "MomenttoCost"))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        using (ExcelPackage xp = new ExcelPackage())
                        {
                            ...
                            ExcelWorksheet ws = xp.Workbook.Worksheets.Add("MomenttoCost");
