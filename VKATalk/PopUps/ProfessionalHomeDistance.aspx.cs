...
namespace VKATalk.PopUps
{
    ...
    public partial class ProfessionalHomeDistance : System.Web.UI.Page
    {
        int _userId = 1;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                int status = 0;
                //DataSet ds = new ProfessionalBL().GetProfessionalTillDateValidation(_professionalId, "HomeDistance", this.btnSave.Text);
                DataSet ds = null;
                //if (btnSave.Text.Equals("Add"))
                //{
                //    ds = new ProfessionalBL().GetProfessionalTillDateValidation(_professionalId, "HomeDistance", txtbxFromDate.Text, btnSave.Text);
                //}
                //else
                //{
                //    ds = new ProfessionalBL().GetProfessionalTillDateValidation((int)ViewState["ProfessionalRecordID"], "HomeDistance", txtbxFromDate.Text, btnSave.Text);
                //}

                if (btnSave.Text.Equals("Add"))
                {
                    ds = new ProfessionalBL().GetProfessionalTillDateValidationProfile(_professionalId, "ProfessionalHomeDistance", txtbxFromDate.Text, btnSave.Text, Convert.ToInt32(drpdwnHomeDistance.SelectedItem.Value));
                }
                else
                {
                    ds = new ProfessionalBL().GetProfessionalTillDateValidationProfile((int)ViewState["ProfessionalRecordID"], "ProfessionalHomeDistance", txtbxFromDate.Text, btnSave.Text, Convert.ToInt32(drpdwnHomeDistance.SelectedItem.Value));
                }
                ...
                else
                {
                    if (btnSave.Text.Equals("Add"))
                    {
                        status = new ProfessionalBL().ProfessionalHomeDistance(
                            _professionalId,
        ...
        {
            DataTable dt = new ProfessionalBL().GetProfessionalNameAutoFiller("HomeDistance", prefixText);
        ...
        {
               DataSet ds = new ProfessionalBL().GetProfessionalNameWithCombination(_professionalId, "HomeDistance");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (!ViewState["ProfessionalRecordID"].Equals(""))
                {
                    ...
                    var status = new ProfessionalBL().ProfessionalHomeDistance((int)ViewState["ProfessionalRecordID"], 0, "__-__-____", "__-__-____", 0, "", this._userId, "Delete");
                    if (status > 0)
                    {
                        ClearAllSelection(this);
                        BindData();
        ...
        protected void btnFileUpload_Click(object sender, EventArgs e)
        {
            try
            {
                if (flupload.HasFile)
                {
                    ...
                    if (Path.GetFileNameWithoutExtension(flupload.PostedFile.FileName).Equals("Professional_HomeDistance"))
                    {
        ...
        private void Import_To_Grid(string FilePath, string Extension)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    var dtErrorResult = new ProfessionalBL().Import30(dt, "ProfessionalHomeDistance");
                    if (dtErrorResult.Rows.Count > 0)
                    {
                        ...
                        {
                            ExcelWorksheet ws = xp.Workbook.Worksheets.Add("Professional_HomeDistance");
                            int rowstart = 1;
                            int colstart = 1;
                            int rowend = rowstart;
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=Professional_HomeDistance.xlsx");
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (DataSet ds = new ProfessionalBL().GetExport(_professionalId, "HomeDistance"))
                {
