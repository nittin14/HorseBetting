<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HorseTreadmill.aspx.cs" Inherits="VKATalk.PopUps.HorseTreadmill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse Treadmill</h1>
        ...
        <div>
            <table align="center">
                 <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="HTreadmill" ShowMessageBox="true" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtbxTreadmillDate" runat="server"></asp:TextBox>
                        ...
                        <asp:MaskedEditExtender ID="mskDateAvailable" CultureName="en-GB" runat="server" 
                                TargetControlID="txtbxTreadmillDate" Mask="99-99-9999" 
                        ...
                        <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ControlToValidate="txtbxTreadmillDate"
                           ...
                           ValidationExpression="(^((((0[1-9])|([1-2][0-9])|(3[0-1]))|([1-9]))-(((0[1-9])|(1[0-2]))|([1-9]))-(([0-9]{2})|(((19)|([2]([0]{1})))([0-9]{2}))))$)"
                            ValidationGroup="HTreadmill" />
                        <asp:CalendarExtender ID="CalendarExtender1" PopupButtonID="ImageButton1" runat="server" TargetControlID="txtbxTreadmillDate"
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkbxfix2" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>Value A:(*)</td>
                    <td>
                        <asp:TextBox ID="txtbxValueA" runat="server" MaxLength="2" Width="50px"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtbxValueA"
                            ErrorMessage="Please Enter Only Numbers" ValidationExpression="^\d+$" ValidationGroup="HTreadmill"></asp:RegularExpressionValidator>
                        <asp:RequiredFieldValidator InitialValue="" ID="Req_ID" Display="Dynamic" 
                            ValidationGroup="HTreadmill" runat="server" ControlToValidate="txtbxValueA"
                            Text="*" ForeColor="Red" ErrorMessage="Please enter Value A."></asp:RequiredFieldValidator>
                ...
                <tr>
                    <td>Value B:(*)</td>
                    <td>
                        <asp:TextBox ID="txtbxValueB" runat="server" MaxLength="5" Width="50px"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtbxValueB"
                            ErrorMessage="Please Enter Only Numbers" ValidationExpression="^[0-9]+(\.[0-9]{1,2})?$" ValidationGroup="HTreadmill"></asp:RegularExpressionValidator>
                        <asp:RequiredFieldValidator InitialValue="" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="HTreadmill" runat="server" ControlToValidate="txtbxValueB"
                            Text="*" ForeColor="Red" ErrorMessage="Please enter Value B."></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" ID="btnShow" Text="Show" OnClick="btnShow_Click" />
                         <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="HTreadmill" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="HTreadmill"/>    
            ...
            <div id="dvGlobal" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvGlobal" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="TreadmillID" 
                    OnSelectedIndexChanged="GvGlobal_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Treadmill Date" ItemStyle-Width="25%">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldTreadmillDate" Value='<%# Bind("TreadmillDate") %>'/>
                                <asp:LinkButton Text='<%# Bind("TreadmillDate") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="ValueA" HeaderText="Value A" ItemStyle-Width="5%" />
                        <asp:BoundField DataField="ValueB" HeaderText="Value B" ItemStyle-Width="5%" />
