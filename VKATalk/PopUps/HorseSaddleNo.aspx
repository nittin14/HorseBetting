<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="HorseSaddleNo.aspx.cs" Inherits="VKATalk.PopUps.HorseSaddleNo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse SaddleNo</h1>
    ...
    <div>
        <table align="center">
            <tr>
                <td>
                    <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="HSaddleNo" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                        Font-Size="12" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="drpdwnCommon" runnat="server" />
                    <asp:RequiredFieldValidator InitialValue="-1" ID="Req_ID" Display="Dynamic"
                        ValidationGroup="HSaddleNo" runat="server" ControlToValidate="drpdwnCommon"
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="drpdwnCommon1" runnat="server" />
                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic"
                        ValidationGroup="HSaddleNo" runat="server" ControlToValidate="drpdwnCommon1"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtbxSaddleNo" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rqv" runat="server" ErrorMessage="Please enter Saddle No" ValidationGroup="HSaddleNo"
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="HSaddleNo" />
                    <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="HSaddleNo" />
                    <asp:Button runat="server" ID="btnDelete" Text="Delete" OnClick="btnDelete_Click" ValidationGroup="HSaddleNo" />
        ...
        <div id="dvGlobal" style="height: 350px; width: 100%; overflow: auto;" runat="server">
            <asp:GridView ID="GvGlobal" runat="server" Width="100%"
                AutoGenerateColumns="False" DataKeyNames="SaddleNoID" OnSelectedIndexChanged="GvGlobal_OnSelectedIndexChanged">
                <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                    HorizontalAlign="Center" />
                <Columns>
                    <asp:TemplateField HeaderText="Center Name" ItemStyle-Width="10%">
                        <ItemTemplate>
                    ...
                    <asp:BoundField DataField="SaddleNo" HeaderText="Saddle No" ItemStyle-Width="15%" />
