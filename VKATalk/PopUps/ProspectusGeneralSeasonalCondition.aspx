<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProspectusGeneralSeasonalCondition.aspx.cs" Inherits="VKATalk.PopUps.ProspectusGeneralSeasonalCondition" %>
    ...
    <script type="text/javascript">
        ...
        function ShowPopup(message) {
            $(function () {
                $("#dialog").html(message);
                $("#dialog").dialog({
                    title: "Master Race Seasonal Condition",
                    buttons: {
                        Close: function () {
                            $(this).dialog('close');
                        }
        ...
        function GetGeneralRaceNameID(source, eventArgs) {
            var HdnKey = eventArgs.get_value();
            document.getElementById('<%=hdnfieldGeneralRaceNameID.ClientID %>').value = HdnKey;
        }

        function SetContextKey() {
            $find('<%=AutoCompleteExtender1.ClientID%>').set_contextKey($get("<%=hdnfieldProspectusGeneralRaceNameID.ClientID %>").value);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">General Race Seasonal Condition</h1>
    ...
    <div>
        <table align="center">
            <tr>
                <td>
                    <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="PGSeasonalCondition" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                        Font-Size="12" />
                    <asp:HiddenField runat="server" ID="hdnfldprospectusid" />
                    <asp:HiddenField runat="server" ID="hdnfieldProspectusGeneralRaceNameID" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox runat="server" ID="txtbxGeneralRaceName" Width="700px" onkeyup="SetContextKey()"></asp:TextBox>
                    <asp:HiddenField runat="server" ID="hdnfieldGeneralRaceNameID" />
                    <div id="listPlacement" style="height: 300px; overflow-y: scroll;">
                        <asp:AutoCompleteExtender ServiceMethod="AddGeneralNameList"
                            ...
                            TargetControlID="txtbxGeneralRaceName" CompletionListElementID="listPlacement"
                            OnClientItemSelected="GetGeneralRaceNameID"
            ...
            <tr>
                <td>Seasonal Condition(*):

                </td>
                <td>
                    <asp:DropDownList ID="drpdwnSeasonalCondition" runat="server" Width="450px"></asp:DropDownList>
                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic"
                        ValidationGroup="PGSeasonalCondition" runat="server" ControlToValidate="drpdwnSeasonalCondition"
                        Text="*" ErrorMessage="Please select seasonal condition"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>From Date:(*)
                ...
                <td>
                    ...
                    <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                        ...
                        ValidationGroup="PGSeasonalCondition" />
            ...
            <tr>
                <td colspan="1"></td>
                <td>
                    <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="PGSeasonalCondition" />
                    <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                    <asp:Button runat="server" ID="btnDelete" Text="Delete" OnClick="btnDelete_Click" ValidationGroup="PGSeasonalCondition" />
        ...
        <div id="dvProspectus" style="height: 350px; width: 100%; overflow: auto;" runat="server">
            <asp:GridView ID="GvProspectus" runat="server" Width="100%"
                AutoGenerateColumns="False" DataKeyNames="PGSeasonalConditionID" OnSelectedIndexChanged="GvProspectus_OnSelectedIndexChanged">
                <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                    HorizontalAlign="Center" />
                <Columns>
                    <asp:TemplateField HeaderText="Seasonal Conditional" ItemStyle-Width="20%">
                        <ItemTemplate>
                            <asp:HiddenField runat="server" ID="hdnfieldtypeofdate" Value='<%# Bind("SeasonalCondition") %>' />
                            <asp:LinkButton Text='<%# Bind("SeasonalCondition") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="MyComments" HeaderText="MyComments" ItemStyle-Width="60%" />
                </Columns>
