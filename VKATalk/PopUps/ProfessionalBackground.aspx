<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProfessionalBackground.aspx.cs" Inherits="VKATalk.PopUps.ProfessionalBackground" Language="C#" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
      ...
      <%-- function GetMasterProspectusID(source, eventArgs) {
           ...
           document.getElementById('<%=hdnfieldprofessionalbackground.ClientID %>').value = HdnKey;
       }--%>
       </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Professional Profession</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="ProfessionalBackground" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpdwnProfBackground" runat="server"></asp:DropDownList>
                        <%--<asp:TextBox ID="txtbxprofessionalbackground" runat="server"></asp:TextBox>
                         <asp:HiddenField ID="hdnfieldprofessionalbackground" runat="server" />
                        <div id="Div1" style="height:300px; overflow-y:scroll;" >
                          <asp:AutoCompleteExtender ServiceMethod="ProfessionalName"
                            ...
                            TargetControlID="txtbxprofessionalbackground" CompletionListElementID="Div1"
                              OnClientItemSelected="GetMasterProspectusID"
                            ID="AutoCompleteExtender2" runat="server" FirstRowSelected="false">
                        </asp:AutoCompleteExtender>
                            </div>--%>
                        <asp:RequiredFieldValidator ID="Req_ID" Display="Dynamic" 
                            ValidationGroup="ProfessionalBackground" runat="server" InitialValue="-1" ControlToValidate="drpdwnProfBackground"
                            Text="*" ForeColor="Red" ErrorMessage="Please select professional background."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>From Date:(*)
                    ...
                    <td>
                        ...
                        <asp:MaskedEditExtender ID="mskDateAvailable" CultureName="en-GB" runat="server" TargetControlID="txtbxFromDate" 
                         ...
                         <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ValidationGroup="ProfessionalBackground" />
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="ProfessionalBackground" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="ProfessionalBackground"/>    
            ...
            <div id="dvHorseProfile" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHorseProfile" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="ProfessionalBackgroundID" OnSelectedIndexChanged="GvHorseProfile_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Profession" ItemStyle-Width="30%">
                            <ItemTemplate>
                                 <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("ProfessionalBackground") %>'/>
                                <asp:HiddenField runat="server" id="hdnfieldmasterprofessionalid" Value='<%# Bind("MasterProfessionalBackgroundID") %>'/>
                                 <asp:LinkButton Text='<%# Bind("ProfessionalBackground") %>' ID="lnkSelect" runat="server" CommandName="Select" /> 
                            </ItemTemplate>
                        </asp:TemplateField>
