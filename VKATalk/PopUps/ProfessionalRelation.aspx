<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProfessionalRelation.aspx.cs" Inherits="VKATalk.PopUps.ProfessionalRelation" Language="C#" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Professional Relation</h1>
      <div id="dialog" style="display: none">
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="Relation" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                    ...
                    <td>
                      ...
                      <asp:HiddenField runat="server" ID="hdnfieldProfessionalnameid" />
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic"
                                    ValidationGroup="Relation" runat="server" ControlToValidate="txtbxSourceName"
                                    Text="*" ErrorMessage="Please enter Related Person Name."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>Relation Type:(*)
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="drpdwnRelationType">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="Relation" runat="server" ControlToValidate="drpdwnRelationType"
                            Text="*" ErrorMessage="Please select Relation Type."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>Relation:(*)
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="drpdwnChildRelation">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic" 
                            ValidationGroup="Relation" runat="server" ControlToValidate="drpdwnChildRelation"
                            Text="*" ErrorMessage="Please select Relation"></asp:RequiredFieldValidator>
                ...
                <tr>
                    <td>Reason For Relation Break: (**)
                    </td>
                    <td colspan="3">
                       <asp:TextBox ID="txtbxRelationBreak" runat="server" Width="300px" Height="35px" TextMode="MultiLine"></asp:TextBox>
                        <div id="listPlacement" style="height:300px; overflow-y:scroll;" ></div>
                          <asp:AutoCompleteExtender ServiceMethod="AddRelationList"
                            ...
                            TargetControlID="txtbxRelationBreak" CompletionListElementID="listPlacement"
                ...
                <tr>
                    <td></td>
                    <td>
                       <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="Relation" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="Relation"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="Relation"/>    
            ...
            <div id="dvHomeDistance" style="height: 220px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHomeDistance" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="RelationID" OnSelectedIndexChanged="GvHomeDistance_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Professional Name" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldProfessionalName" Value='<%# Bind("ProfessionalName") %>'/>
                                <asp:HiddenField runat="server" id="hdnfieldRelatedPersonID" Value='<%# Bind("RelatedPersonID") %>'/>
                                <asp:HiddenField runat="server" id="hdnfieldGroupID" Value='<%# Bind("GroupID") %>'/>
                                <asp:LinkButton Text='<%# Bind("ProfessionalName") %>' ID="lnkSelect" runat="server" CommandName="Select" /> 
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="RelationType" HeaderText="Relation Type" ItemStyle-Width="10%" />
                        <asp:BoundField DataField="Relation" HeaderText="Relation" ItemStyle-Width="10%" />
                        ...
                        <asp:BoundField DataField="RelationBreak" HeaderText="RelationBreak" ItemStyle-Width="25%" />
