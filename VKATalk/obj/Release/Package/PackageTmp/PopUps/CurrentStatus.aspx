<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentStatus.aspx.cs" MasterPageFile="~/Site.Master" Inherits="VKATalk.PopUps.CurrentStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse Current Status</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="CurrentStatus" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpdownStatus" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>From Date:(*)
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="CurrentStatus" />
            ...
            <div id="dvHorseStatus" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvCurrentStatus" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="CurrentStatusID" OnSelectedIndexChanged="GvCurrentStatus_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />

                    <Columns>
                        <asp:TemplateField HeaderText="Current Status" ItemStyle-Width="40">
                            <ItemTemplate>
