<%@ Page AutoEventWireup="true" CodeBehind="ProfessionalOwnerColor.aspx.cs" Inherits="VKATalk.PopUps.ProfessionalOwnerColor" Language="C#" MasterPageFile="~/Site.Master" %>
      ...
      <script type="text/javascript">
          function ShowPopup(message) {
              $(function () {
                  $("#dialog").html(message);
                  $("#dialog").dialog({
                      title: "Professional Owner Color",
                      buttons: {
                          Close: function () {
                              $(this).dialog('close');
                          }
          ...
          function GetHorseID(source, eventArgs) {
              ...
              document.getElementById('<%=hdnfieldProfessionalOwnerColorID.ClientID %>').value = HdnKey;
        }
       </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Professional Owner Color</h1>
       <div id="dialog" style="display: none">
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="ProfessionalOwnerColor" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                    ...
                    <td>
                        <asp:Label runat="server" ID="lblProfessionalFirst"></asp:Label>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtbxOwnerColor" Width="700px"></asp:TextBox>
                                <asp:HiddenField runat="server" ID="hdnfieldProfessionalOwnerColorID" />
                                <div id="Div1" style="height: 300px; overflow-y: scroll;">
                                    <asp:AutoCompleteExtender ServiceMethod="AddProfessionalOwnerColorList"
                                        ...
                                        TargetControlID="txtbxOwnerColor" CompletionListElementID="Div1"
                                        OnClientItemSelected="GetHorseID"
                                        ID="AutoCompleteExtender2" runat="server" FirstRowSelected="false">
                                    </asp:AutoCompleteExtender>
                                </div>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic"
                                    ValidationGroup="ProfessionalOwnerColor" runat="server" ControlToValidate="txtbxOwnerColor"
                                    Text="*" ErrorMessage="Please enter Owner Color."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>Center:(*)
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="ProfessionalOwnerColor" runat="server" ControlToValidate="drpdwnCenter"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtbxFromDate" runat="server" ValidationGroup="ProfessionalOwnerColor"></asp:TextBox>
                        ...
                        <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ValidationGroup="ProfessionalOwnerColor" />
                ...
                <tr>
                    <td></td>
                    <td>
                         <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="ProfessionalOwnerColor" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="ProfessionalOwnerColor"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="ProfessionalOwnerColor"/>    
            ...
            <div id="dvHorseProfile" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHorseProfile" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="ProfessionalOwnerColorID" OnSelectedIndexChanged="GvHorseProfile_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Owner Color" ItemStyle-Width="30%">
                            <ItemTemplate>
                                 <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("OWNERCOLOR") %>'/>
                                 <asp:HiddenField runat="server" id="hdnfieldOwnerColorID" Value='<%# Bind("OWNERCOLORID") %>'/>
                                 <asp:LinkButton Text='<%# Bind("OWNERCOLOR") %>' ID="lnkSelect" runat="server" CommandName="Select" /> 
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="CenterName" HeaderText="Center Name" ItemStyle-Width="30" />
