<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TargetRace.aspx.cs" Inherits="VKATalk.PopUps.TargetRace" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse Target Race</h1>
       <div id="dialog" style="display: none">
        ...
        <div>
            <table align="center">
                 <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="Htargetrace" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Race General Name:(*)
                    </td>
                    <td>
                       <asp:TextBox runat="server" ID="txtbxProspectusMasterName" Width="700px"></asp:TextBox>
                                ...
                                <div id="listPlacement" style="height: 300px; overflow-y: scroll;">
                                    <asp:AutoCompleteExtender ServiceMethod="AddProspectusList"
                                        ...
                                        TargetControlID="txtbxProspectusMasterName" CompletionListElementID="listPlacement"
                        ...
                        <asp:RequiredFieldValidator InitialValue="" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="Htargetrace" runat="server" ControlToValidate="txtbxProspectusMasterName"
                            Text="*" ForeColor="Red" ErrorMessage="Please enter Race General Name."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>From Date:(*)
                ...
                <tr>
                    <td></td>
                    <td>
                         <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="Htargetrace" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="Htargetrace"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="Htargetrace"/>    
            ...
            <div id="dvGlobal" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvGlobal" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="TargetRaceID" OnSelectedIndexChanged="GvGlobal_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Race General Name" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("GeneralRaceName") %>'/>
                                <asp:HiddenField runat="server" id="hdnfieldGeneralRaceID" Value='<%# Bind("GeneralRaceNameID") %>'/>
                        ...
                        <asp:BoundField DataField="SeasonName" HeaderText="Season" ItemStyle-Width="5%" />
                        <asp:BoundField DataField="YearName" HeaderText="Year" ItemStyle-Width="5%" />
