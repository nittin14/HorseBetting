<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProspectusGeneralRaceNewName.aspx.cs" Inherits="VKATalk.PopUps.ProspectusGeneralRaceNewName" %>
    ...
    <script type="text/javascript">
        ...
        function ShowPopup(message) {
            $(function () {
                $("#dialog").html(message);
                $("#dialog").dialog({
                    title: "Prospect General Race New Name",
                    buttons: {
                        Close: function () {
                            $(this).dialog('close');
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ToolkitScriptManager5" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">General Race New Name</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="PropGRaceNewName" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                         <asp:HiddenField runat="server" ID="hdnfldgeneralracenameid"/>
                        <%--<asp:HiddenField runat="server" ID="hdnfieldmasterraceid"/>--%>
                        <asp:HiddenField runat="server" ID="hdnfieldMasterID"/>
                        <%--<asp:HiddenField runat="server" ID="hrseDateofNameChange"/>--%>
                    </td>
                </tr>
                <tr>
                    <td>General Race New Name:(*)
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rqv" runat="server" ErrorMessage="Please enter Prospectus Race Name" ValidationGroup="PropGRaceNewName" ControlToValidate="txtbxRaceName">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>General Race New Name Alias:(*)
                    </td>
                    <td>
                        <asp:TextBox ID="txtbxRaceNameAlias" runat="server" Width="500px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter Alias name" ValidationGroup="PropGRaceNewName" ControlToValidate="txtbxRaceNameAlias">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                 <tr>
                       ...
                       <asp:TextBox ID="txtbxDateofNameChange" runat="server"></asp:TextBox>
                        ...
                        <asp:MaskedEditExtender ID="mskDateAvailable" CultureName="en-GB" runat="server" TargetControlID="txtbxDateofNameChange" 
                         ...
                         <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ValidationGroup="PropGRaceNewName" />
                ...
                <tr>
                    <td colspan="1"></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="PropGRaceNewName" />
                        <asp:Button runat="server" ID="btnDelete" Text="Delete" OnClick="btnDelete_Click" ValidationGroup="PropGRaceNewName" />
             ...
             <div id="dvProspectus" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvProspectus" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="GeneralRaceNameAlias" HeaderText="Alias" ItemStyle-Width="20%" />
