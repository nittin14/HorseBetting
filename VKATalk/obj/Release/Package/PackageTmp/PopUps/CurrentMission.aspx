<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="CurrentMission.aspx.cs" Inherits="VKATalk.PopUps.CurrentMissionPopup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse CurrentMission</h1>
        ...
        <div>
            <table align="center">
                 <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="CurrentMission" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                ...
                <tr>
                    ...
                    <td>
                       <asp:DropDownList ID="drpdwnCurrentMission" runat="server"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" InitialValue="-1" runat="server" ErrorMessage="Please enter Current Mission." ValidationGroup="CurrentMission" 
                            ControlToValidate="drpdwnCurrentMission">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>From Date:(*)
                    ...
                    <td>
                        ...
                        <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                           ...
                           ValidationExpression="(^((((0[1-9])|([1-2][0-9])|(3[0-1]))|([1-9]))-(((0[1-9])|(1[0-2]))|([1-9]))-(([0-9]{2})|(((19)|([2]([0]{1})))([0-9]{2}))))$)"
                            ValidationGroup="CurrentMission" />
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="CurrentMission" />
            ...
            <div id="dvCurrentMission" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvCurrentMission" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="CurrentMissionID" OnSelectedIndexChanged="GvCurrentMission_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Current Mission">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("CurrentMission") %>'/>
                                <asp:LinkButton Text='<%# Bind("CurrentMission") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
