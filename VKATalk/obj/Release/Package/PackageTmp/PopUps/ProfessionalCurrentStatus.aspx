<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProfessionalCurrentStatus.aspx.cs" Inherits="VKATalk.PopUps.ProfessionalCurrentStatus" Language="C#" %>
...
<script type="text/javascript">
    function ShowPopup(message) {
        $(function () {
            $("#dialog").html(message);
            $("#dialog").dialog({
                title: "Professional Current Status",
                buttons: {
                    Close: function () {
                        $(this).dialog('close');
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Professional Current Status</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="ProfessionalCurrentStatus" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" id="drpdwnCurrentStatus"/>
                    </td>
                </tr>
                <tr>
                    <td>From Date:(*)
                    ...
                    <td>
                        ...
                        <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ValidationGroup="ProfessionalCurrentStatus" />
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="ProfessionalCurrentStatus" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="ProfessionalCurrentStatus"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="ProfessionalCurrentStatus"/>    
            ...
            <div id="dvHorseName" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHorseStatus" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="ProfessionalCurrentStatusID" OnSelectedIndexChanged="GvHorseStatus_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Professional Current Status" ItemStyle-Width="30">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("CurrentStatusType") %>'/>
                                <asp:LinkButton Text='<%# Bind("CurrentStatusType") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
