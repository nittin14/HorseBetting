<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProfessionalJockeyAprenticeOf.aspx.cs" Inherits="VKATalk.PopUps.ProfessionalJockeyAprenticeOf" Language="C#" %>
     ...
     <script type="text/javascript">
         function ShowPopup(message) {
             $(function () {
                 $("#dialog").html(message);
                 $("#dialog").dialog({
                     title: "Professional JockeeyAprentic Of",
                     buttons: {
                         Close: function () {
                             $(this).dialog('close');
                         }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Professional Jockey's Master Trainer</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="AprenticeOf" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                    ...
                    <td>
                      ...
                      <asp:HiddenField runat="server" ID="hdnfieldProfessionalnameid" />
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic"
                                    ValidationGroup="AprenticeOf" runat="server" ControlToValidate="txtbxSourceName"
                ...
                <tr>
                    <td></td>
                    <td>
                         <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="AprenticeOf" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="AprenticeOf"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="AprenticeOf"/>    
            ...
            <div id="dvHorseProfile" style="height: 250px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHorseProfile" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="JockeyAprenticeOfID" OnSelectedIndexChanged="GvHorseProfile_OnSelectedIndexChanged">
