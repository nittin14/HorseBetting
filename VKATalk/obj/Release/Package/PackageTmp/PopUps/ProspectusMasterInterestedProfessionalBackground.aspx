<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProspectusMasterInterestedProfessionalBackground.aspx.cs" Inherits="VKATalk.PopUps.ProspectusMasterInterestedProfessionalBackground" Language="C#" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
   ...
   <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Master Interested profession Background</h1>
      <div id="dialog" style="display: none">
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="PMBackground" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                ...
                <tr>
                    <td>Interested Professional Background:(*)
                    </td>
                    <td>
                        <asp:DropDownList runat="server" id="drpdwnPBackground"/>
                         <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic" 
                            ValidationGroup="PMBackground" runat="server" ControlToValidate="drpdwnPBackground"
                            Text="*" ErrorMessage="Please select interestedd professional background."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>From Year:(*)
                    ...
                    <td>
                       <asp:DropDownList runat="server" id="drpdwnFromYear"/>
                         <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="PMBackground" runat="server" ControlToValidate="drpdwnFromYear"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <div id="Div1" style="height:300px; overflow-y:scroll;" ></div>
                          <asp:AutoCompleteExtender ServiceMethod="OtherDetails"
                            ...
                            TargetControlID="txtbxOtherDetails" CompletionListElementID="Div1"
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="PMBackground" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="PMBackground"/>    
            ...
            <div id="dvHProspectus" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvProspectus" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="IBPID" OnSelectedIndexChanged="GvHorseStatus_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Professional Background" ItemStyle-Width="20%">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="OtherDetails" HeaderText="Other Details" ItemStyle-Width="30%" />
