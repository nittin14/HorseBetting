<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProspectusMasterHanRatingRange.aspx.cs" Inherits="VKATalk.PopUps.ProspectusMasterHanRatingRange" Language="C#" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
   ...
   <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Master Race Handicap Rating Range</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="ProspectusMasterHanRatingRange" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                ...
                <tr>
                    <td>Handicap Rating Range:(*)
                    </td>
                    <td>
                        <asp:DropDownList runat="server" id="drpdwnHandicapRatingRange"/>
                         <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic" 
                            ValidationGroup="ProspectusMasterHanRatingRange" runat="server" ControlToValidate="drpdwnHandicapRatingRange"
                            Text="*" ErrorMessage="Please select Handicap Rating Range"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>Class:(*)
                    ...
                    <td>
                        <asp:DropDownList runat="server" id="drpdwnClass"/>
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator3" Display="Dynamic" 
                            ValidationGroup="ProspectusMasterHanRatingRange" runat="server" ControlToValidate="drpdwnClass"
                            Text="*" ErrorMessage="Please select Class"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                 <tr>
                    <td>From Year:(*)
                    ...
                    <td>
                       <asp:DropDownList runat="server" id="drpdwnFromYear"/>
                         <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="ProspectusMasterHanRatingRange" runat="server" ControlToValidate="drpdwnFromYear"
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="ProspectusMasterHanRatingRange" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="ProspectusMasterHanRatingRange"/>    
            ...
            <div id="dvHProspectus" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvProspectus" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="MasterHandicapRatingRangeID" OnSelectedIndexChanged="GvHorseStatus_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Rating Range" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("HandicapRatingRange") %>'/>
                                <asp:LinkButton Text='<%# Bind("HandicapRatingRange") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="ClassType" HeaderText="Class" ItemStyle-Width="5%" />
