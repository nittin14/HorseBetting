<%@ Page AutoEventWireup="true" CodeBehind="HorseProfile.aspx.cs" Inherits="VKATalk.PopUps.HorseProfile" Language="C#" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse Profile</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="HorseProfile" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="drpdwnProfile">
                         ...
                         <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="HorseProfile" runat="server" ControlToValidate="drpdwnProfile"
                            Text="*" ErrorMessage="Please select Profile."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>From Date:(*)
                    ...
                    <td>
                        <asp:TextBox ID="txtbxFromDate" runat="server" ValidationGroup="HorseProfile"></asp:TextBox>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="HorseProfile" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="HorseProfile"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="HorseProfile"/>    
            ...
            <div id="dvHorseProfile" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHorseProfile" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="HorseProfileID" OnSelectedIndexChanged="GvHorseProfile_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Profile" ItemStyle-Width="30%">
                            <ItemTemplate>
                                 <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("Profile") %>'/>
                                 <asp:LinkButton Text='<%# Bind("Profile") %>' ID="lnkSelect" runat="server" CommandName="Select" /> 
                            </ItemTemplate>
                        </asp:TemplateField>
