<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AddHorseStatus.aspx.cs" Inherits="VKATalk.PopUps.AddHorseStatus" Language="C#" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
   ...
   <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Permanent Status</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="HorseStatus" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
                <tr>
                ...
                <%--<tr>
                    ...
                    <td>
                       <asp:Button ID="btnAddOwner" runat="server" Text="Add Owner" OnClientClick="Popup('AddOwner')" />
                    </td>
                </tr>--%>
                <tr>
                    <td>From Date:(*)
            ...
            <div id="dvHorseName" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHorseStatus" runat="server" Width="100%"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Permanent Status" ItemStyle-Width="30">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("HorseStatus") %>'/>
                                <asp:LinkButton Text='<%# Bind("HorseStatus") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
