<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="HorseMyObservations.aspx.cs" Inherits="VKATalk.PopUps.HorseMyObservations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse MyObervation</h1>
        ...
        <div>
            <table align="center">
                 <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="HMyObservation" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                ...
                <tr>
                    ...
                    <td>
                      <asp:RadioButtonList runat="server" id="rdbtn" RepeatDirection="Horizontal">
                          <asp:ListItem Value="1" Text="Short Term" Enabled="True" Selected="True"></asp:ListItem>
                          <asp:ListItem  Value="2" Text="Long Term"></asp:ListItem>
                          </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtbxObservations" runat="server" Width="250px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                        <div id="Div6" style="height:300px; overflow-y:scroll;" ></div>
                          <asp:AutoCompleteExtender ServiceMethod="AddObservation"
                            ...
                            TargetControlID="txtbxObservations" CompletionListElementID="Div6"
                            ID="AutoCompleteExtender1" runat="server" FirstRowSelected="false">
                        </asp:AutoCompleteExtender>
                        <asp:RequiredFieldValidator InitialValue="" ID="RequiredFieldValidator1" Display="Dynamic" 
                            ValidationGroup="HMyObservation" runat="server" ControlToValidate="txtbxObservations"
                            Text="*" ForeColor="Red" ErrorMessage="Please enter My Observation."></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>Reason:
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="TxtbxReason" runat="server" Width="250px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                        <div id="Div1" style="height:300px; overflow-y:scroll;" ></div>
                          <asp:AutoCompleteExtender ServiceMethod="AddAimedList"
                            MinimumPrefixLength="1" CompletionListCssClass="AutoExtender" CompletionListHighlightedItemCssClass="AutoExtenderHighlight" CompletionListItemCssClass=".AutoExtenderList"
                            CompletionInterval="100" EnableCaching="false" CompletionSetCount="10"
                            TargetControlID="TxtbxReason" CompletionListElementID="Div1"
                    ...
                    <td>
                        ...
                        <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                           ...
                           ValidationExpression="(^((((0[1-9])|([1-2][0-9])|(3[0-1]))|([1-9]))-(((0[1-9])|(1[0-2]))|([1-9]))-(([0-9]{2})|(((19)|([2]([0]{1})))([0-9]{2}))))$)"
                            ValidationGroup="HMyObservation" />
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="HMyObservation" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="HMyObservation"/>    
        ...
        <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" style = "display:none">
            ...
            <div id="dvGlobal" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvGlobal" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="MyObservationsID" OnSelectedIndexChanged="GvGlobal_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Aimed Duration" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <asp:HiddenField runat="server" id="hdnfieldStatus" Value='<%# Bind("AimedDuration") %>'/>
                                <asp:LinkButton Text='<%# Bind("AimedDuration") %>' ID="lnkSelect" runat="server" CommandName="Select" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="MyObservation" HeaderText="My Observation" ItemStyle-Width="15%" />
                        <asp:BoundField DataField="Reason" HeaderText="Reason" ItemStyle-Width="20%" />
