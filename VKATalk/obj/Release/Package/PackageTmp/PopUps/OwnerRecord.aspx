<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OwnerRecord.aspx.cs" Inherits="VKATalk.PopUps.OwnerRecord" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
       ...
       function SetContextKey() {
           $find('<%=AutoCompleteExtender4.ClientID%>').set_contextKey($get("<%=hdnfieldGeneralRaceNameID.ClientID %>").value);
       }
       </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Horse Owner</h1>
       ...
       <div>
            <table align="center">
                 <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="OwnerRecord" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                        ...
                        <asp:HiddenField runat="server" ID="hdnfieldHorseNameID" />
                                                <div id="Div2" style="height: 300px; overflow-y: scroll;">
                                                    <asp:AutoCompleteExtender ServiceMethod="AddHorseList"
                                                        ...
                                                        TargetControlID="txtbxHorseName" CompletionListElementID="Div2"
                ...
                <tr>
                    ...
                    <td>
                            ...
                            ValidationGroup="OwnerRecord" runat="server" ControlToValidate="txtbxProfessionalName"
                            Text="*" ForeColor="Red" ErrorMessage="Please select Owner Record."></asp:RequiredFieldValidator>
                            </td>
                    <%--<td>
                        <asp:DropDownList runat="server" ID="drpdwnGender" runnat="server" />
                        <asp:RequiredFieldValidator InitialValue="-1" ID="Req_ID" Display="Dynamic" 
                            ValidationGroup="OwnerRecord" runat="server" ControlToValidate="drpdwnGender"
                ...
                <tr>
                    ...
                    <td colspan="3">
                      <%-- <asp:RadioButtonList runat="server" ID="rdbtnStatus" RepeatDirection="Horizontal">
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="OwnerRecord" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" />
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="OwnerRecord"/>    
            ...
            <div id="dvGlobal" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvGlobal" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="OwnerRecordID" OnSelectedIndexChanged="GvGlobal_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Owner Name" ItemStyle-Width="10%">
                            <ItemTemplate>
