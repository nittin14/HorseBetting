<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MyHomeDistance.aspx.cs" Inherits="VKATalk.PopUps.MyHomeDistance" Language="C#" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Add Horse MyHomeDistance</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="MyHomeDistance" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator InitialValue="-1" ID="reqFieldValidatior" Display="Dynamic" 
                            ValidationGroup="MyHomeDistance" runat="server" ControlToValidate="drpdwnHomeDistance"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic" 
                            ValidationGroup="MyHomeDistance" runat="server" ControlToValidate="drpdwnSupportType"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator3" Display="Dynamic" 
                            ValidationGroup="MyHomeDistance" runat="server" ControlToValidate="drpdwnSupportLevel"
                    ...
                    <td>
                        ...
                        <asp:MaskedEditExtender ID="mskDateAvailable" CultureName="en-GB" runat="server" TargetControlID="txtbxFromDate" 
                         ...
                         <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ValidationGroup="MyHomeDistance" />
                ...
                <tr>
                    <td></td>
                    <td>
                         <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="MyHomeDistance" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="MyHomeDistance"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="MyHomeDistance"/>    
            ...
            <div id="dvHomeDistance" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHomeDistance" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="MyHomeDistanceID" OnSelectedIndexChanged="GvHomeDistance_OnSelectedIndexChanged">
