<%@ Page AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProfessionalFavDistanceGroup.aspx.cs" Inherits="VKATalk.PopUps.ProfessionalFavDistanceGroup" Language="C#" %>
    ...
    <script type="text/javascript">
        function ShowPopup(message) {
            $(function () {
                $("#dialog").html(message);
                $("#dialog").dialog({
                    title: "Professional Favorable Distance Group",
                    buttons: {
                        Close: function () {
                            $(this).dialog('close');
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Professional Home Distance Length</h1>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="FavDistanceGroup" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                            Font-Size="12" />
                    </td>
                </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator InitialValue="-1" ID="reqFieldValidatior" Display="Dynamic" 
                            ValidationGroup="FavDistanceGroup" runat="server" ControlToValidate="drpdwnHomeDistance"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator2" Display="Dynamic" 
                            ValidationGroup="FavDistanceGroup" runat="server" ControlToValidate="drpdwnSupportType"
                    ...
                    <td>
                        ...
                        <asp:MaskedEditExtender ID="mskDateAvailable" CultureName="en-GB" runat="server" TargetControlID="txtbxFromDate" 
                         ...
                         <asp:MaskedEditValidator ID="MaskedEditValidator5" runat="server"
                            ...
                            ValidationGroup="FavDistanceGroup" />
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button runat="server" ID="btnSave" Text="Add" OnClick="btnSave_Click" ValidationGroup="FavDistanceGroup" />
                        <asp:Button runat="server" ID="btnClear" Text="Clear" OnClick="btnClear_Click" ValidationGroup="FavDistanceGroup"/>
                        <asp:Button runat="server" id="btnDelete" text="Delete" OnClick="btnDelete_Click" ValidationGroup="FavDistanceGroup"/>    
            ...
            <div id="dvHomeDistance" style="height: 350px; width: 100%; overflow: auto;" runat="server">
                <asp:GridView ID="GvHomeDistance" runat="server" Width="100%"
                    AutoGenerateColumns="False" DataKeyNames="HomeDistanceGroupID" OnSelectedIndexChanged="GvHomeDistance_OnSelectedIndexChanged">
                    <EmptyDataRowStyle Font-Names="Calibri" Font-Size="Medium" ForeColor="Red"
                        HorizontalAlign="Center" />
                    <Columns>
                        <asp:TemplateField HeaderText="Home Distance Length" ItemStyle-Width="10%">
                            <ItemTemplate>
