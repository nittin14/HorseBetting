<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CardVeterinary.aspx.cs" Inherits="VKATalk.Card.CardVeterinary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenHorsePopup(value) {
            ...
            if (value === "Veterinery") {
                window.open('../Popups/HorseVeterinaryProblem.aspx?HorseNameID=0&HorseName=NULL&HorseDOB=00-00-0000&PageName=2&GeneralRaceNameID=0' + generalracenameid, '_blank', 'status=yes, toolbar=no, menubar=no, location=center');
            }
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Card Veterinary</h1>
            ...
            <td>
                <fieldset style="width: 100%;" class="Userlogin">
                    <table>
                        <tr>
                            <td colspan="2">
                                <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="CardVeterinary" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                                    Font-Size="12" />
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 5px;">
                                ...
                                <asp:MaskedEditValidator ID="MaskedEditValidator1" runat="server"
                                    ...
                                    ValidationGroup="CardVeterinary" />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <asp:GridView ID="GvShowALL" runat="server" Width="100%" AutoGenerateColumns="false"
                    DataKeyNames="DivisionRaceID" EmptyDataText="No Record Found" OnSelectedIndexChanged="GvShowALL_OnSelectedIndexChanged" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Disease" HeaderText="Disease" ItemStyle-Width="20%" />
