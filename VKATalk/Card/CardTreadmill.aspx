<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CardTreadmill.aspx.cs" Inherits="VKATalk.Card.CardTreadmill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenHorsePopup(value) {
            ...
            if (value === "Veterinery") {
                window.open('../Popups/HorseTreadmill.aspx?HorseNameID=0&HorseName=NULL&HorseDOB=00-00-0000&PageName=2&GeneralRaceNameID=' + generalracenameid, '_blank', 'status=yes, toolbar=no, menubar=no, location=center');
            }
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Card Treadmill</h1>
            ...
            <td>
                <fieldset style="width: 100%;" class="Userlogin">
                    <table>
                        <tr>
                            <td colspan="2">
                                <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="CardTreadmill" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                                    Font-Size="12" />
            ...
            <ContentTemplate>
                <asp:GridView ID="GvShowALL" runat="server" Width="100%" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TreadmillDate" ReadOnly="true" HeaderText="Treadmill Date" ItemStyle-Width="5%" />
                        <asp:BoundField DataField="Rounds" ReadOnly="true" HeaderText="Treadmill Rounds (Value A - Value B)" ItemStyle-Width="5%" />
    ...
    <table border="1">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnVeterinary" runat="server" Text="Treadmill Update" OnClientClick="OpenHorsePopup('Veterinery')" />
                            </td>
