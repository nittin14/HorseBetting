...
namespace VKATalk.Card
{
    ...
    public partial class CardTreadmill : System.Web.UI.Page
    {
        ...
        protected void drpdwnCenterName_SelectIndexChange(object sender, EventArgs e)
        {
            try
            {
                ...
                var ds = new CardsBL().GetAcceptanceDivisionDetailMultipleReturn(
                     txtbxRaceDate.Text,
                     Convert.ToInt32(drpdwnCenterName.SelectedItem.Value), "CardTreadmill");
                ...
                //    lblSeason.Text = dt.Rows[0][3].ToString();
                //    lblYear.Text = dt.Rows[0][4].ToString();
