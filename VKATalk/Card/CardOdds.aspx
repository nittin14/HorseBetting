<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CardOdds.aspx.cs" Inherits="VKATalk.Card.CardOdds" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 style="text-align: center; font-size: xx-large; font-weight: bold; text-decoration: underline;">Card Odds</h1>
            ...
            <td>
                <fieldset style="width: 100%;" class="Userlogin">
                    <table>
                        <tr>
                            <td colspan="2">
                                <asp:ValidationSummary ID="VSummary" runat="server" ValidationGroup="CardOdds" ShowMessageBox="true" ShowSummary="false" Font-Names="verdana"
                                    Font-Size="12" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Horse Name(*)" ItemStyle-Width="20%">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField runat="server" ID="hdnfieldGlobalID" Value='<%# Bind("GlobalID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="NOW" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxNowG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("NOW") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="MOW" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxMOWG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("MOW") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="LOOW" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxLOOWG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("LOOW") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="OOW" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxOOWG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("OOW") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="OOP" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxOOPG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("OOP") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="MDW" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxMDWG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("MDW") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="MOP" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxMOPG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("MOP") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="COW" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxCOWG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("COW") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="COP" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtbxCOPG" Width="105px" MaxLength="5" runat="server" Text='<%# Bind("COP") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
   ...
   <%-- <table border="1">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnVeterinary" runat="server" Text="Veterinary Problem Update" OnClientClick="OpenHorsePopup('Veterinery')" />
                            </td>
    ...
    <table align="center">
        <tr>
            <td>
                <asp:Button runat="server" ID="btnAdd" Text="Add" OnClick="btnAdd_Click" ValidationGroup="CardOdds" /></td>
            <td>
