...
{
    public partial class MasterHandicapWeightPenaltyCriteria : System.Web.UI.Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    status = Bl.HandicapWeightCriteria(0, txtbxBunchCondition.Text, 1, "Insert");
                }
                else
                {
                    status = Bl.HandicapWeightCriteria((int)ViewState["GridViewRowID"], txtbxBunchCondition.Text, 1, "Update");
                }
        ...
        private void BindData()
        {
            ...
            {
                DataTable dt;
                dt = Bl.GetMasterData("MasterHandicapWeightCriteria");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (!ViewState["GridViewRowID"].Equals(""))
                {
                    ...
                    var status = Bl.HandicapWeightCriteria((int)ViewState["GridViewRowID"], "", 1, "Delete");
                    ClearAllSelection(this);
                    BindData();
                    BtnSubmit.Text = "Add";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (DataTable dt = Bl.GetMasterData("MasterHandicapWeightCriteria"))
                {
                    if (dt.Rows.Count > 0)
                    {
                        dt.Columns.Remove("RowCount");
                        dt.Columns.Remove("HWPCriteriaID");
                        using (ExcelPackage xp = new ExcelPackage())
                        {

                            ExcelWorksheet ws = xp.Workbook.Worksheets.Add("MasterHandicapWeightCriteria");
                            ...
                            //  }
                            Response.AddHeader("content-disposition", "attachment;filename=Master_HandicapWeightPenaltyCriteria.xlsx");
        ...
        protected void btnFileUpload_Click(object sender, EventArgs e)
        {
            try
            {
                if (flupload.HasFile)
                {
                    ...
                    if (Path.GetFileNameWithoutExtension(flupload.PostedFile.FileName).Equals("Master_HandicapWeightPenaltyCriteria"))
                    {
        ...
        private void Import_To_Grid(string FilePath, string Extension)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    var dtErrorResult = new MasterBL().ImportExcel30(dt, "MasterHandicapWeightCriteria");
