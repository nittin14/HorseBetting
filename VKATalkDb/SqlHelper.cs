...
/// </summary>
    ...
    public sealed class SqlHelper
    {
        ...
        /// <summary>
        /// Returns Connection string reading from Web.config file Appsetting value
        /// AppSetting Parameter is ConnectionString
        /// </summary>
        public static string connectionString
        {
            //get
            //{
            //    return ConfigurationSettings.AppSettings["LendLeaseConnectionString"].ToString();
            //}
            get
            {
                ...
                {
                    connectionstring = _connectionStringOverride;
                }

                else if (System.Configuration.ConfigurationManager.AppSettings["SiteStaging"].ToString() == "Production")
                {
                    connectionstring = System.Configuration.ConfigurationManager.AppSettings["Production.database.ConnectionString"].ToString();
                }

                else if (System.Configuration.ConfigurationManager.AppSettings["SiteStaging"].ToString() == "Test")
                {
                    connectionstring = System.Configuration.ConfigurationManager.AppSettings["Test.database.ConnectionString"].ToString();
                }

                else if (System.Configuration.ConfigurationManager.AppSettings["SiteStaging"].ToString() == "Development")
                {
                    connectionstring = System.Configuration.ConfigurationManager.AppSettings["Development.database.ConnectionString"].ToString();
                }
